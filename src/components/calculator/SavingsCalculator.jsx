  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 p-4 rounded-lg">
        <h5 className="font-semibold text-blue-800 mb-2">Savings Growth:</h5>
        <div className="space-y-1 text-sm">
          <div>Total Savings: <span className="font-bold text-blue-800">${totalSavings.toLocaleString('en-US', { maximumFractionDigits: 2 })}</span></div>
          <div>Total Deposited: <span className="font-medium">${totalDeposited.toLocaleString('en-US', { maximumFractionDigits: 2 })}</span></div>
          <div>Total Interest Earned: <span className="font-medium text-green-600">${totalInterest.toLocaleString('en-US', { maximumFractionDigits: 2 })}</span></div>
