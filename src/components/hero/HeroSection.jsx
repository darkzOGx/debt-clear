        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <motion.div
            ...
            <p className="text-lg lg:text-xl text-neutral-700 max-w-2xl mb-8 leading-relaxed font-light">
              <strong>AI-powered debt settlement and debt relief</strong> for Orange County residents. Expert debt settlement services 
              reduce your debt by 50% in 12-24 months. Licensed debt relief specialists trusted by over 1,200+ county residents.
            </p>
