  ...
  const navigation = [
    ...
    { 
      ...
      submenu: [
        ...
        { name: 'Debt Settlement Brea', href: '/debt-settlement-brea' },
        { name: 'Debt Settlement Costa Mesa', href: '/debt-settlement-costa-mesa' },
        { name: 'Debt Settlement Cypress', href: '/debt-settlement-cypress' },
        ...
        { name: 'Debt Settlement La Habra', href: '/debt-settlement-la-habra' },
