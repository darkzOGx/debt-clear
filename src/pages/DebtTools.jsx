...
export default function DebtTools() {
  useCanonicalLink('https://orangecountydebtcenter.com/debt-tools');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://orangecountydebtcenter.com/debt-tools" />
        <meta property="og:image" content="https://orangecountydebtcenter.com/og-financial-calculators.jpg" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://orangecountydebtcenter.com/debt-tools",
            "publisher": {
              "@type": "Organization",
              "name": "OC Debt Center",
