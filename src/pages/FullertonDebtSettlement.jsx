        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-neutral-700 leading-relaxed mb-8 font-light">
              AI-powered debt relief for Fullerton residents. Reduce your debt by up to 50% 
              with our licensed debt settlement specialists serving the 92831-92837 area.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              ...
              <div>
                <div className="text-3xl font-light text-black mb-2">$4.2M+</div>
                <div className="text-sm text-neutral-600 font-mono">Debt Resolved</div>
              </div>
              <div>
                <div className="text-3xl font-light text-black mb-2">650+</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-light text-black mb-6">
                Serving Fullerton's
                <br />
                <span className="font-mono">Educational Community</span>
              </h2>
              
              <p className="text-lg text-neutral-700 leading-relaxed mb-6">
                Home to Cal State Fullerton and a vibrant educational community, Fullerton residents 
                often face unique financial challenges including student loans and family expenses. 
                Our debt settlement specialists understand the local economy and work with Fullerton families to achieve debt freedom.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-black mb-1">Fullerton Local Expertise</div>
                    <div className="text-neutral-600 text-sm">Understanding of 92831-92837 area economics and university community</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-black mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-semibold text-black mb-1">Student Debt Specialists</div>
                    <div className="text-neutral-600 text-sm">Special programs for Cal State Fullerton students and graduates</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-black mt-1 flex-shrink-0" />
                  <div>
                    <div className="font-semibold text-black mb-1">North County Access</div>
                    <div className="text-neutral-600 text-sm">Convenient location serving northern Orange County residents</div>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h3 className="text-xl font-semibold text-black mb-6">Fullerton Demographics</h3>
              
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="text-2xl font-light text-black mb-1">139,921</div>
                  <div className="text-sm text-neutral-600 font-mono">Population</div>
                </div>
                <div>
                  <div className="text-2xl font-light text-black mb-1">$82,577</div>
                  <div className="text-sm text-neutral-600 font-mono">Median Income</div>
                </div>
                <div>
                  <div className="text-2xl font-light text-black mb-1">22.4 sq mi</div>
                  <div className="text-sm text-neutral-600 font-mono">Area</div>
                </div>
                <div>
                  <div className="text-2xl font-light text-black mb-1">1957</div>
                  <div className="text-sm text-neutral-600 font-mono">Founded</div>
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="text-sm text-neutral-700">
                  Anaheim, Buena Park, La Habra, Brea, Placentia
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-light text-black mb-6">
              ...
              <br />
              <span className="font-mono">Fullerton Residents</span>
            </h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto font-light">
              Comprehensive debt relief solutions tailored to the unique financial needs of the Fullerton community.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Negotiate with major credit card companies to reduce balances by up to 50% for Fullerton residents.",
                features: ["Discover, American Express negotiations", "Average 40-60% reduction", "24-48 month programs"]
              },
              {
                icon: Users,
                title: "Student Loan Resolution",
                description: "Specialized programs for Cal State Fullerton students and graduates facing educational debt.",
                features: ["Federal loan consolidation", "Income-driven repayment plans", "Forgiveness program applications"]
              },
              {
                icon: Clock,
                title: "Medical Debt Relief",
                description: "Strategic settlement of medical debt from St. Jude Medical Center and area healthcare providers.",
            ...
            {[
              {
                ...
                description: "Comprehensive debt analysis for Fullerton residents with no upfront costs."
              },
              {
                step: "02", 
                title: "Custom Strategy",
                description: "Personalized debt settlement plan based on your Fullerton financial situation."
              },
              {
                step: "03",
              ...
              },
              {
                step: "04",
                title: "Debt Freedom",
                description: "Complete your program and achieve financial freedom in Fullerton."
              }
            ].map((step, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                ...
                amount: "$42,000",
                reduction: "51%",
                testimonial: "As a Cal State Fullerton graduate, they understood my student debt situation and helped with my credit cards too."
              },
              {
                name: "Michael R.",
                location: "Near CSUF Campus",
                amount: "$35,000", 
                reduction: "49%",
                testimonial: "Professional service with deep knowledge of educational debt. They helped my family navigate complex financial issues."
              },
              {
                name: "Jessica L.",
                location: "Fullerton 92832",
                amount: "$31,000",
                reduction: "54%",
                testimonial: "They helped me become debt-free while understanding the challenges of living in this educational community."
              }
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-light mb-6">
              Ready to Start Your
              <br />
              <span className="font-mono">Fullerton Debt Settlement?</span>
            </h2>
            
            <p className="text-xl text-neutral-300 mb-8 max-w-2xl mx-auto font-light">
              Join hundreds of Fullerton residents who have achieved debt freedom. 
