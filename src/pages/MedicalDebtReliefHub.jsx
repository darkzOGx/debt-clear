...
export default function MedicalDebtReliefHub() {
  ...
  useCanonicalLink('https://orangecountydebtcenter.com/medical-debt-relief-hub');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://orangecountydebtcenter.com/medical-debt-relief-hub" />
        <meta property="og:image" content="https://orangecountydebtcenter.com/og-medical-debt-relief.jpg" />
        ...
        <meta name="twitter:image" content="https://orangecountydebtcenter.com/og-medical-debt-relief.jpg" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://orangecountydebtcenter.com/medical-debt-relief-hub",
            "mainEntity": {
