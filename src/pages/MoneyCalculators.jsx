...
},    {      title: "Debt Settlement vs Bankruptcy Calculator",      description: "Compare debt settlement, Chapter 7, and Chapter 13 bankruptcy options to find the best solution for your financial situation.",      icon: Calculator,      calculator: DebtSettlementVsBankruptcyCalculator    },    {      title: "Credit Card Debt Relief Calculator (Under $5K)",      description: "Specialized calculator for smaller credit card debts. Compare aggressive payoff, balance transfers, and settlement options.",      icon: Target,      calculator: CreditCardDebtReliefCalculator
    }
  ];
