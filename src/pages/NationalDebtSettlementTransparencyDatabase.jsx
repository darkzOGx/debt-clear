...
export default function NationalDebtSettlementTransparencyDatabase() {
  ...
  useCanonicalLink('https://orangecountydebtcenter.com/national-debt-settlement-transparency-database');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://orangecountydebtcenter.com/national-debt-settlement-transparency-database" />
        <meta property="og:image" content="https://orangecountydebtcenter.com/og-transparency-database.jpg" />
        ...
        <meta name="twitter:image" content="https://orangecountydebtcenter.com/og-transparency-database.jpg" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "url": "https://orangecountydebtcenter.com/national-debt-settlement-transparency-database",
            "creator": {
              "@type": "Organization",
