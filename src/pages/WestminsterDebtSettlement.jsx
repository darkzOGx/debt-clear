          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <span className="text-xs uppercase tracking-[0.2em] text-white font-mono">
                WESTMINSTER DEBT SETTLEMENT SERVICES
              </span>
            </div>
            ...
            <h1 className="text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">
              Debt Settlement:<br />
              <span className="font-mono text-3xl lg:text-4xl">Westminster, CA</span>
            </h1>

            {/* Subheadline */}
            <p className="text-xl text-neutral-300 leading-relaxed font-light relative z-10 max-w-3xl mx-auto mb-8">
              Multicultural community debt relief for Westminster residents. Our AI-powered approach helps 
              diverse families and small business owners reduce debt by up to 50% in Orange County's Little Saigon.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              >
                Free Westminster Debt Analysis
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-light text-black mb-4">
              Westminster <span className="font-mono">Community Profile</span>
            </h2>
            <p className="text-neutral-600 max-w-2xl mx-auto">
              Little Saigon debt solutions for Orange County's diverse community
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 border border-neutral-200 text-center">
              <div className="text-2xl font-mono text-black mb-2">$2.8M+</div>
              <div className="text-xs text-neutral-600 font-mono">Debt Resolved</div>
            </div>
            
            <div className="bg-white p-6 border border-neutral-200 text-center">
              <div className="text-2xl font-mono text-black mb-2">485+</div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-black mb-6">
              Debt Solutions for <span className="font-mono">Little Saigon Community</span>
            </h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              Culturally sensitive financial solutions for Westminster's diverse population
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="space-y-8">
                <div className="border-l-4 border-black pl-6">
                  <h3 className="text-xl font-semibold text-black mb-3">Vietnamese-American Families</h3>
                  <p className="text-neutral-600 mb-4">
                    Westminster's Little Saigon community faces unique challenges with 
                    language barriers, cultural financial practices, and family business debt.
                  </p>
                  <ul className="space-y-1 text-sm text-neutral-600">
                    <li>• Vietnamese-speaking debt counselors</li>
                    <li>• Cultural financial understanding</li>
                    <li>• Family business debt relief</li>
                    <li>• Immigration-related debt assistance</li>
                  </ul>
                </div>
                ...
                <div className="border-l-4 border-black pl-6">
                  ...
                  <p className="text-neutral-600 mb-4">
                    Local entrepreneurs in restaurants, retail, and services facing 
                    debt from economic fluctuations and competition in diverse markets.
                  </p>
                  <ul className="space-y-1 text-sm text-neutral-600">
                    <li>• Restaurant business debt</li>
                    <li>• Retail shop settlements</li>
                    <li>• Commercial lease negotiations</li>
                    <li>• Equipment financing issues</li>
                  </ul>
                </div>
                ...
                <div className="border-l-4 border-black pl-6">
                  ...
                  <p className="text-neutral-600 mb-4">
                    Diverse working families managing mortgage payments, education 
                    costs, and credit card debt in Orange County's competitive environment.
                  </p>
                  <ul className="space-y-1 text-sm text-neutral-600">
                    <li>• Multilingual debt assistance</li>
                    <li>• Educational loan support</li>
            ...
            <div className="bg-neutral-50 p-8 lg:p-12 border border-neutral-200">
              <h3 className="text-2xl font-light text-black mb-8">
                <span className="font-mono">Westminster</span> Success Stories
              </h3>
              
              <div className="space-y-6">
                <div className="bg-white p-6 border border-neutral-200">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="text-2xl font-mono text-black">$68K</div>
                    <div className="text-sm text-neutral-600">reduced to $25K</div>
                  </div>
                  <p className="text-xs text-neutral-500">
                    Restaurant owner eliminated business debt while keeping Little Saigon location
                  </p>
                </div>
                ...
                <div className="bg-white p-6 border border-neutral-200">
                  ...
                  <p className="text-xs text-neutral-500">
                    Vietnamese-American family resolved credit card debt with culturally sensitive approach
                  </p>
                </div>
                ...
                <div className="bg-white p-6 border border-neutral-200">
                  ...
                  <p className="text-xs text-neutral-500">
                    Retail business owner settled inventory debt while maintaining community connections
                  </p>
                </div>
              </div>
