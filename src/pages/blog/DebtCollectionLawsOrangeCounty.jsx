      ...
      <section className="py-16 bg-neutral-50 border-b border-neutral-200">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="flex items-center gap-6 text-sm font-mono text-neutral-500 mb-8">
            <div className="flex items-center gap-2"><Calendar className="w-4 h-4" /><span>October 20, 2024</span></div>
      ...
      <article className="py-16">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-semibant text-black mb-6 mt-12">Federal and California Consumer Protections</h2>
            ...
            <div className="bg-blue-50 border border-blue-200 p-8 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div><h3 className="text-lg font-semibant text-blue-800 mb-4">Prohibited Collection Practices</h3>
            ...
            <h2 className="text-2xl font-semibant text-black mb-6 mt-12">California-Specific Protections</h2>
            <div className="space-y-6 mb-8">
              <div className="border border-neutral-200 p-6">
                <h4 className="font-semibant text-black mb-3">Wage Garnishment Limits</h4>
              ...
              <div className="border border-neutral-200 p-6">
                <h4 className="font-semibant text-black mb-3">Statute of Limitations</h4>
              ...
              <div className="border border-neutral-200 p-6">
                <h4 className="font-semibant text-black mb-3">Asset Protection</h4>
            ...
            <h2 className="text-2xl font-semibant text-black mb-6 mt-12">Filing Complaints in Orange County</h2>
            <div className="bg-neutral-50 p-8 border border-neutral-200 mb-8">
              <h3 className="text-xl font-semibant text-black mb-4">Where to Report Violations</h3>
            ...
            <div className="bg-neutral-50 border border-neutral-200 p-8 mb-8">
              <h3 className="text-xl font-semibant text-black mb-4">Consumer Rights Disclaimer</h3>
