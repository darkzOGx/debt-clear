...
import { ArrowLeft, Calendar, Clock, User, DollarSign, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 bg-gradient-to-b from-black to-neutral-900 text-white overflow-hidden border-b border-neutral-800">
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-6"><div className="w-2 h-2 bg-white"></div><span className="text-xs uppercase tracking-[0.2em] text-neutral-400 font-mono">COST ANALYSIS</span></div>
          <h1 className="text-4xl lg:text-5xl font-light text-white mb-6 leading-tight">Orange County Debt Settlement Fees:<br /><span className="font-mono text-3xl lg:text-4xl">Understanding the Costs</span></h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-neutral-50 border border-neutral-200 p-8 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div><h3 className="text-lg font-semibold text-black mb-4">Legal Fee Requirements</h3>
            ...
            <div className="bg-neutral-50 border border-neutral-200 p-8 mb-8">
              <h3 className="text-xl font-semibold text-black mb-4">$50,000 Debt Settlement</h3>
