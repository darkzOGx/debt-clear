      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Orange County Tax Debt Relief 2025: Complete IRS Resolution Guide",
            ...
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": "https://vegaxai.com/blog/orange-county-tax-debt-relief-2025"
            }
          })}
        </script>
      </Helmet>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-gradient-to-br from-black to-neutral-900 border border-neutral-200 p-8 rounded-lg">
                  ...
                  <div className="space-y-3 text-black">
                    ...
                    <p className="flex items-center gap-2">
                      <ChevronRight className="w-4 h-4" />
                      Investment income underreporting
                    </p>
                    <p className="flex items-center gap-2">
                      <ChevronRight className="w-4 h-4" />
                ...
                <div className="bg-gradient-to-br from-black to-neutral-900 border border-neutral-200 p-8 rounded-lg">
                  ...
                  <div className="space-y-3 text-black">
                    ...
                    <p className="flex items-center gap-2">
                      <ChevronRight className="w-4 h-4" />
                      Employment tax trust fund penalties
                    </p>
                  </div>
                </div>
              </div>
